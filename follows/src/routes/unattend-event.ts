...
router.post(
    ...
    try {
        await EventFollowTransactions.unattendEvent(currentGoerEventFollows, eventFollowers, currentUserObjectId, eventObjectId);
    } catch (err) {
        console.log(err);
...
export { router as unattendEventRouter };